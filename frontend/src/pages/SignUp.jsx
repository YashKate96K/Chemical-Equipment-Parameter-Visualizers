...
import { UserPlus, Beaker } from 'lucide-react'
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-12">
        ...
        <p className="text-sm text-white italic font-[cursive] drop-shadow-sm mt-1">
          Sign up to upload, analyze, and visualize your chemical equipment datasets
        </p>
      </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-300">
                Sign up to upload and analyze datasets
              </p>
            </div>
          </div>
