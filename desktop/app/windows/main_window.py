...
from widgets.dataset_list import DatasetListWidget
...
class MainWindow(QMainWindow):
    ...
    def create_status_bar(self):
        ...
        # User label (will be updated after login)
    ...
    def show_login(self):
        ...
        if login_dialog.exec_() == 1:
            ...
            if token:
                self.current_user = login_dialog.username_input.text().strip()
    ...
    def logout(self):
        ...
        if reply == QMessageBox.Yes:
            self.current_user = "Guest"
            self.user_label.setText(f"User: {self.current_user}")
            self.status_label.setText("Logged out - Direct Access Mode")
            ...
            try:
                ...
                self.status_label.setText(f"Error refreshing datasets: {str(e)}")
